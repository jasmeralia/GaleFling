...
; build/version.nsh is generated by build/build.spec from src/utils/_version.py,
; which is itself generated by scripts/write_version.py from a release git tag
; (or a dev version derived from `git describe` for local builds). The version
; is not stored anywhere in source — see AGENTS.md's "Version Management".
